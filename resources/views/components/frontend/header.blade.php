                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse" id="gazetteMenu">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item {{ request()->routeIs('frontend.posts.*') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('frontend.posts.index') }}">Artikels</a>
                                    </li>
                                ...
                                <div class="header-search-form mr-auto">
                                    <form action="{{ route('frontend.posts.index') }}" method="GET">
                                        <input type="search" placeholder="Zoek artikels..."
                                            id="search" name="q" value="{{ request('q') }}">
                                    </form>
                                </div>
                                <div id="searchbtn">
